...
int main(int argc, char *argv[]) {
	system ("chcp 1253");
	int a,sum = 0,sum3 = 0,negative = 1; // αριθμός, πλήθος, πλήθος πολλαπλασίων του 3 και αρνητικοί
	double polla3 = 1.0,polla4 = 1.0; // πολλαπλάσια του 3 και 4
	char choice; // για το πέρας του επαναληπτικού βρόχου
	while(1){	
		...
		choice = getchar();
		if(choice == 'O' || choice == 'o' || choice == 'Ο' || choice == 'ο') break; 
